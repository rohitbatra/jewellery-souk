<div class="item">
	...
	<div class="post_content">
		...
		<div class="media-content">
			...
			<?php if($display_date_added || $display_author || $display_comment || $display_view):?>	
				<div class="media-subcontent">
				<?php if($display_author){ ?>
					<span class="media-author"><span class="txt">By: </span><span class="author"><?php echo ucwords($blog['author']); ?></span></span>
				<?php }?>
				<?php if($display_date_added){ ?>
					<span class="media-date-added"><i class="fa fa-calendar"></i> <?php echo date('F jS, Y', strtotime($blog['date_modified'])) ?></span>
				<?php }?>
