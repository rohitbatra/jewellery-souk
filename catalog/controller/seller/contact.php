...
class ControllerSellerContact extends Controller {
    ...
    {
        $this->load->language('seller/contact');
        ...
        $data['breadcrumbs'][] = array(
          ...
          'href' => $this->url->link('seller/contact', '', true)
        );
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            $mail->setTo('seller.support@sezplus.com');
            ...
            $data['success'] = "We've received your query, our team will contact you shortly!";
        }
