        	...
        	<div class="product-view-inner clearfix">
				...
				<div class="content-product-right <?php if(isset($thumbnails_position) && $thumbnails_position == 'bottom') echo "info-right"; ?> <?php  echo $right_gallery; ?>">
					...
					<div class="title-product">
					 ...
					 <!-- Review ---->
					 <?php if ($review_status && $count_reviews) { ?>
					...
					<div id="product">
						...
						<?php foreach ($options as $option) { ?>
							...
							<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?> form-select">
							   ...
							   <div class="cart">
								...
								<div class="add-to-links wish_comp">
									<ul class="blank">
										...
										<li class="compare">
											<a class="icon" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-random"></i></a>
										</li>
									</ul>
								</div>
					...
					<?php //Tabs Left Position -------?>
						...
						<?php endif; ?>
							<div class="tab-content <?php if ($tabs_position == 1){ echo "col-lg-9 col-sm-8"; }?> col-xs-12">
									...
									<form>
										...
										<?php if ($review_guest) { ?>
											<div class="contacts-form">
												...
												<?php echo $captcha; ?>
												<div class="buttons clearfix" style="visibility: visible;"><a id="button-review" class="btn btn-info"><?php echo $button_continue; ?></a></div>
								...
								<?php if ($tags) : ?>
								<div id="tab-4" class="<?php echo (!$description && !$attribute_groups && !$review_status ? 'tab-pane active in' : 'tab-pane '); ?>">
								...
								<?php if (!empty($html_product_tab)) : ?>
								<div id="tab-5" class="<?php echo (!$description && !$attribute_groups && !$review_status && !$tags ? 'tab-pane  active in' : 'tab-pane '); ?>">
