			...
			?>
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<?php echo create_position('Header Block1','header_block1',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12">
							<?php echo create_position('Header Block2','header_block2',$layout_modules,$extensions,$module_row); ?>
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-12"> 
							<?php echo create_position('Menu Vertical 2','content_menu2',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12"> 
				...
				<div class="well"> 
					<div class="row">
						...
						<?php 
						if (isset($layout_route))	:
						if(($layout_route['route'])=='mobile/home'  ) : ?>
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-12"> 
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-6 col-sm-6"> 
							<?php echo create_position('Content Footer Top (Used in Footer 1,2)','footertop',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-6"> 
							<?php echo create_position('Content Top 1 (Used in Footer 1,2)','footer_top1',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block1 (Used in Footer 1,2)','footer_block1',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block2 (Used in Footer 1,2)','footer_block2',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block3','footer_block3',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block4','footer_block4',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block5','footer_block5',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block6','footer_block6',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Content Footer Bottom','footerbottom',$layout_modules,$extensions,$module_row); ?>
						</div>
					 </div>
				</div>
