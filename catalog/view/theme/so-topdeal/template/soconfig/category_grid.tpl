<?php if ($products) { ?>
	...
	<!--Changed Listings-->
	<?php 
        if (file_exists(DIR_SYSTEM . '/storage/modification/catalog/view/theme/'.$theme.'/template/soconfig/listing.php'))
            include (DIR_SYSTEM . '/storage/modification/catalog/view/theme/'.$theme.'/template/soconfig/listing.php');
        elseif (file_exists(DIR_TEMPLATE . $theme . '/template/soconfig/listing.php')) include(DIR_TEMPLATE.$theme.'/template/soconfig/listing.php');
        else echo 'Not found';
    ?>
