								...
								<div class="button-group ">
									<div class="button-inner so-quickview">
										...
										<?php if($display_wishlist){?>
											<button class="wishlist bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_wishlist'); ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
										<?php } ?>
										
										<?php if($display_compare){?>
											<button class="compare bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-refresh"></i></button>
										<?php }?>
										<?php if($display_add_to_cart){?>
											<button class="addToCart bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span class="hidden"><?php echo $objlang->get('button_cart'); ?></span></button>
										<?php } ?>
