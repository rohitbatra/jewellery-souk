                        ...
                        <div id="enquiry-table">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-left"><img class="img-thumbnail" src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim($sender_email)));?>" /> <?php echo $sender_name;?> <?php if(!$is_seller) { ?> <br/> <small>- e-Mail: <?php echo $sender_email; ?></small><br/> <small>- Telephone: <?php echo $sender_telephone; ?></small> <?php } ?></td>
