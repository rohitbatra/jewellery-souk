<?php
	...
	$txtemail_id = 'txtemail' . rand() . time();
?>
		...
		<div class="modcontent">
			<div class="oca_popup" id="test-popup">
				<div class="popup-content">
					...
					<form method="post" id="signup" name="signup" class="form-group signup">
						<div class="input-control">
							<div class="email">
								<input type="email" placeholder="<?php echo $newsletter_placeholder ; ?>" value="" class="form-control" id="txtemail" name="txtemail">
							</div>
							<button class="btn btn-cool btn-default send-mail" type="submit" onclick="return subscribe_newsletter();" name="submit">
                    ...
                    success: function(json) {
                        ...
                        if(json.message == "Subscription Successfull") {
                            ...
                            setTimeout(function () {
                                ...
                                this_close.parents().find('.common-home').removeClass('hidden-scorll'); // fixbugs
                            }, 3000);
                        }else{
                            $('.send-mail').after('<span class="show-error" style="color: red;margin-left: 10px"> ' + json.message + '</span>');
                        }
                        var x = document.getElementById('signup'); // fixbugs
