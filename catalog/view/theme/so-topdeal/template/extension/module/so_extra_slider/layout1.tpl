<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	...
	<div class="head-title clearfix">
		<h2 class="modtitle"><span><?php echo $head_name; ?></span></h2>
	</div>
	<?php } ?>
								...
								<?php if($display_addtocart || $display_readmore_link || $display_wishlist || $display_compare) { ?>
									<div class="button-group">
										<div class="button-inner so-quickview">
											...
											<button  class="addToCart bts" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');">
												<span class="hidden"><?php echo $objlang->get('button_cart'); ?></span>
											</button>
											<?php } ?>
											...
											<button class="compare bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
											<?php } ?>
									...
									<!-- Begin item-content -->
										...
										<div class="total-price">
											...
											<div class="price-sale price-right">
												<?php if ($product['special'] && $display_sale) : ?>
													<span class="discount"><?php echo $product['discount']; ?>
