							...
							<?php  if($display_add_to_cart || $display_wishlist || $display_compare){?>
								<div class="button-group2">
									<?php if($display_add_to_cart){?>
										<button class="bt-cart" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span class=""><?php echo $objlang->get('button_cart'); ?></span></button>
									<?php } ?>
