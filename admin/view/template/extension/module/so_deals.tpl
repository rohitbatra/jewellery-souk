			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
				...
				<div class="row">
					...
					<?php // -----------------------------------------------------------------------?>
							...
							<div class="form-group"> <?php //<!--Include JS --> ?>
								<label class="col-sm-3 control-label" for="input-thumbnailSlide"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_include_js_desc'); ?>"><?php echo $objlang->get('entry_include_js'); ?></span></label>
								<div class="col-sm-9">
									<div class="col-sm-5">
										<label class="radio-inline">
											<?php if ($module['include_js'] == 'owlCarousel') { ?>
											<input type="radio" name="include_js" value="owlCarousel" checked="checked" />
											<?php echo $objlang->get('text_owl_carousel'); ?>
											<?php } else { ?>
										...
										<label class="radio-inline">
											<?php if ($module['include_js'] == 'slick') { ?>
											<input type="radio" name="include_js" value="slick" checked="checked" />
											<?php echo $objlang->get('text_slick_slider'); ?>
											<?php } else { ?>
							...
							<div class="form-group owl-carousel"> <?php //<!-- Row --> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--Display Feature --> ?>
							...
							<div class="form-group owl-carousel" id="input-product_feature_form"> <?php //<!--Product Feature --> ?>
							...
							<div class="form-group slick-slide"> <?php //<!-- position thumbnail --> ?>
								<label class="col-sm-3 control-label" for="input-position_thumbnail"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_position_thumbnail_desc'); ?>"><?php echo $objlang->get('entry_position_thumbnail'); ?> </span></label>
								<div class="col-sm-9">
									<div class="col-sm-5">
										<select name="position_thumbnail" id="input-position_thumbnail" class="form-control">
											<?php 
											foreach($position_thumbnails as $option_id => $option_value)
											{
											$selected = ($option_id == $module['position_thumbnail']) ? 'selected' :'';
											?>
											<option value="<?php echo $option_id ?>" <?php echo $selected ?> ><?php echo $option_value ?></option>
											<?php
												}
					...
					<?php // -----------------------------------------------------------------------?>
						<div class="tab-pane" id="items_option"> <?php //<!--Item Option --> ?>
							...
							<div class="form-group"> <?php //<!--Display CountDown --> ?>
								<label class="col-sm-3 control-label" for="input-display_countdown"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_display_countdown_desc'); ?>"><?php echo $objlang->get('entry_display_countdown'); ?></span></label>
								<div class="col-sm-9">
									<div class="col-sm-5">
										<label class="radio-inline">
											<?php if ($module['display_countdown']) { ?>
					...
					<?php // -----------------------------------------------------------------------?>
						<div class="tab-pane" id="effect_option"> <?php //<!--Effect Option --> ?>
							<div class="form-group owl-carousel"> <?php //<!--Margin --> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--mouse Drag--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--touch Drag--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--button page--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--dots--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--dots Speed--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--nav Speed--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--effect--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--duration--> ?>
							...
							<div class="form-group owl-carousel"> <?php //<!--delay--> ?>
					...
					<?php // -----------------------------------------------------------------------?>
						<div class="tab-pane" id="advanced_option"> <?php //<!--Advanced Option --> ?>
							<div class="form-group"> <?php //<!-- Store Layout --> ?>
								<label class="col-sm-3 control-label" for="input-store_layout"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_store_layout_desc'); ?>"><?php echo $objlang->get('entry_store_layout'); ?> </span></label>
								<div class="col-sm-9">
									<div class="col-sm-5">
										<select name="store_layout" id="input-store_layout" class="form-control">
											<?php
											foreach($store_layouts as $option_id => $option_value)
											{
											$selected = ($option_id == $module['store_layout']) ? 'selected' :'';
											?>
											<option value="<?php echo $option_id ?>" <?php echo $selected ?> ><?php echo $option_value ?></option>
											<?php
												}
...
<script type="text/javascript"><!--
	...
	$('input[name=\'product_feature\']').autocomplete({
		source: function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/module/so_deals/autocomplete_product_feature&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
				dataType: 'json',
				success: function(json) {
					response($.map(json, function(item) {
						return {
