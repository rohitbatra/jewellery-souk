			...
			<?php global $module_row;$module_row = 0; ?>
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Content Head','content_head',$layout_modules,$extensions,$module_row); ?>
						</div>
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Top (Used in Footer 1)','footertop',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Block1 (Used in Footer 2)','footer_block1',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Block2 (Used in Footer 3)','footer_block2',$layout_modules,$extensions,$module_row); 
