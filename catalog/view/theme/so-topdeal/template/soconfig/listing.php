				...
				<div class="button-group">
					<div class="button-inner">
						<?php if (!isset($quick_status) || $quick_status ) : ?>
							<a class="bts quickview iframe-link visible-lg btn-button" data-toggle="tooltip" title="<?php echo isset($quick_view_text) && is_string($quick_view_text) ? $quick_view_text : 'Quick View'; ?>" data-fancybox-type="iframe"  href="<?php echo $our_url->link('extension/soconfig/quickview','product_id='.$product['product_id']);?>"> <i class="fa fa-search"></i> </a>
						<?php endif; ?>
		...
		<div class="product-item-container">
			...
			<div class="right-block col-md-8">
			  ...
			  <div class="button-group">
				...
				<button class="compare btn-button" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-random"></i></button>
			  </div>
