								...
								<div class="left-block">
									...
									<div class="button-group">
										<div class="button-inner">
											<!-- QUICK VIEW -->
											<?php if ( $quick_status ) : ?>
												<a class="bts quickview iframe-link visible-lg btn-button" data-fancybox-type="iframe"  href="<?php echo $our_url->link('extension/soconfig/quickview','product_id='.$product['product_id']);?>"> <i class="fa fa-search"></i> </a>
											<?php endif; ?>
