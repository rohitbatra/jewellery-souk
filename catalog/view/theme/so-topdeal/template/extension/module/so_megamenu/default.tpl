			...
			<div class="megamenuToogle-wrapper hidden-sm hidden-xs">
				<div class="megamenuToogle-pattern font-ct">
					<div class="container">
							...
							<span class="title-mega"><?php echo $navigation_text; ?></span>
					</div>
				</div>
			</div>
		</div>
									...
									echo '<div class="row">';
										...
										echo '<div class="col-sm-'.$submenu['content_width'].'">';
												if($submenu['content_type'] == '0') {
													...
													echo '<h4 class="title-feature">'.$submenu['name'][$lang_id].'</h4>';
													if(is_array($submenu['product'])) {
													echo '<div class="product '.$submenu['class_menu'].'">';
														echo '<div class="image"><a href="'.$submenu['product']['link'].'" onclick="window.location = \''.$submenu['product']['link'].'\';"><img src="'.$submenu['product']['image'].'" alt=""></a></div>';
														echo '<h4 class="name"><a href="'.$submenu['product']['link'].'" onclick="window.location = \''.$submenu['product']['link'].'\';">'.$submenu['product']['name'].'</a></h4>';
														echo '<div class="price">';
															if (!$submenu['product']['special'])
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(itemver <= $( ".vertical ul.megamenu >li" ).length)
			$('.vertical ul.megamenu').append('<li class="loadmore"><i class="fa fa-plus"></i><span class="more-view"> <?php echo $text_more_category ?></span></li>');
		...
		$(".megamenu .loadmore").click(function(){
			if($(this).hasClass('open')){
				...
				$('.loadmore').html('<i class="fa fa-plus"></i><span class="more-view"><?php echo $text_more_category ?></span>');
			}else{
				$('ul.megamenu li.item-vertical').each(function(i){
						if(i>show_itemver){
								$(this).slideDown(200);
				...
				$(this).addClass('open');
				$('.loadmore').html('<i class="fa fa-minus"></i><span class="more-view"><?php echo $text_close_category ?></span>');
			}
		});
	});
</script>
