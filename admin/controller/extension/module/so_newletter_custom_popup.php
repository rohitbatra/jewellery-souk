...
class ControllerExtensionModuleSonewlettercustompopup extends Controller {
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['name']) < 3) || (utf8_strlen($this->request->post['name']) > 264)) {
		...
		foreach($languages as $language){
			...
			if ((utf8_strlen($module_description[$language['language_id']]['head_name']) < 3) || (utf8_strlen($module_description[$language['language_id']]['head_name']) > 264)) {
				$this->error['head_name'] = $this->language->get('error_head_name');
			}
		}
		foreach($languages as $language){
			$description_content = $this->request->post['description_content'];
			if ((utf8_strlen(html_entity_decode($description_content[$language['language_id']]['title'])) < 3) || (utf8_strlen(html_entity_decode($description_content[$language['language_id']]['title'])) > 264)) {
