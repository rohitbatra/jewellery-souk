...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Seller Payment <?php if($payment_status !== 'success') { echo 'Failed'; } else { echo 'Success'; } ?> | <?php echo $web_name; ?></title>
    <!--
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <table class="body-sub">
                        <tr>
                          <td>
                            <!-- <p class="sub">Need a printable copy for your records?</strong> You can <a href="">download a PDF version</a>.</p> -->
                            <!-- <p class="sub">Moved recently? Have a new credit card? You can easily <a href="">update your billing information</a>.</p> -->
                          </td>
                        </tr>
                      </table>
                    </td>
