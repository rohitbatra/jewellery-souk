<?php
class ControllerSellerPaymentError extends Controller {

    public function index()
    {
      $heading_title = 'Your Transaction has Failed!';
      ...
      $data['breadcrumbs'][] = array(
        'text' => 'Error',
        'href' => $this->url->link('seller/payment_error', 'uID=' . ($this->request->get['uID']), true)
      );

      $data['continue'] = $this->url->link('seller/payment_process', 'uID=' . ($this->request->get['uID']), true);
      $data['button_continue'] = 'Pay Now';
      ...
      $this->response->setOutput($this->load->view('seller/payment_error',$data));
    }
}
