				...
				<div class="item <?php echo ($p==1 ? 'active' : ''); ?>">
					<div class="product-thumb transition">
						<div class="caption">
							...
							<p class="des"><?php echo  html_entity_decode($product['description_maxlength']); ?></p>
							<?php } ?>
							...
							<?php if($display_addtocart || $display_wishlist || $display_compare){	?>
								...
								<?php if($display_addtocart){?>
									<button class="bt-cart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span class=""><?php echo $objlang->get('button_cart'); ?></span></button>
								<?php }?>
