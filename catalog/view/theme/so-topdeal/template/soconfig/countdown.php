            ...
            if ($day_end !== 0 && $year_end !==0 && $month_end !== 0) :
                ...
                <div class="countdown_box">
                    <div class="countdown_inner">
                        <div class="title hidden"><?php echo (isset($countdown_title) && $countdown_title != '' ? $countdown_title : 'This limited  offer ends in:'); ?></div>
                        ...
                        <div class="item-box defaultCountdown-<?php echo $product['product_id']; ?>"></div>
                    </div>
