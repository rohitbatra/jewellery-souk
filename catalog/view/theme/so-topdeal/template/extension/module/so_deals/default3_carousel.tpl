...
<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	...
	<div class="modcontent">
	    ...
	    <div id="<?php echo $tag_id?>" class="so-deal modcontent products-list grid clearfix <?php echo $class_respl; ?> <?php if($button_page == "top"){echo "button-type1";}else{echo "button-type2";} ?> style2">
			...
			<div class="product-feature product-layout">
								...
								<div class="button-group">
									<div class="button-inner so-quickview">
										...
										<?php if($display_addtocart){?>
											<button class="addToCart btn-button" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden"><?php echo $objlang->get('button_cart'); ?></span></button>
										<?php	}?>
									</div>
								</div>
							<?php } ?>
									...
									<div class="price-sale price-right">
										<?php if ($product['special'] && $display_sale) : ?>
											<span class="discount">
												...
												?>
												<strong><?php echo $objlang->get('text_off'); ?></strong>
											</span>
										<?php endif; ?>
									</div>
								</div>
	                    		...
	                    		<div class="left-block">
			                        <div class="product-image-container second_img">
										...
										<?php if($product['location'] !='') { ?>
											<div class="text-location"><span><?php echo $product['location'] ?></span></div>
										<?php } ?>
			                        ...
			                        ?>
			                            <div class="button-group">
			                            	<div class="button-inner so-quickview">
					                            ...
					                            <?php if($display_wishlist)
					                            {?>
					                                <button class="wishlist btn-button bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_wishlist'); ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o"></i></button>
					                            <?php
					                            }?>
					                            <?php if($display_compare)
					                            {?>
					                                <button class="compare btn-button bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-random"></i></button>
					                            <?php }?>
					                            <?php if($display_addtocart)
					                            {?>
					                                <button class="addToCart btn-button bts" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart hidden-lg hidden-md"></i> <span class="hidden hidden-sm hidden-md"><?php echo $objlang->get('button_cart'); ?></span></button>
					                            <?php
					                            }?>
