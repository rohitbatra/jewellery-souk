<div id="<?php echo $tag_id?>" class="so-deal modcontent clearfix <?php echo $class_respl; ?> <?php if($button_page == "top"){echo "button-type1";}else{echo "button-type2";} ?> style2">
	...
	<div class="product-feature products-list grid">
					...
					<div class="product-item-container ">
						...
						<div class="right-block">
							...
							?>
								...
								<?php if($display_addtocart)
								{?>
									<button class="bt-cart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="hidden hidden-sm hidden-md fa fa-shopping-cart"></i> <span class=""><?php echo $objlang->get('button_cart'); ?></span></button>
								<?php
								}?>
								<?php if($display_wishlist)
								{?>
