							...
							<div class="col-sm-2">
								...
								<select name="soconfig_general_store[<?php echo $store["store_id"] ?>][themecolor]" class="form-control text-capital" id="select_color_<?php echo $store["store_id"] ?>">
									<?php
										...
										if(!empty($allThemeColor[$store["store_id"]]) || !isset($allThemeColor[$store["store_id"]])){
											foreach ($allThemeColor[$store["store_id"]] as $fv => $fc) {
									...
									<?php 
											...
											echo '<option value="0"> No Item</option>	';
										}
				...
				<div class="so-panel">
					...
					<div class="panel-container">	
						...
						<div class="form-group" id="tab-general__preloader">
							...
							<div class="col-sm-10">
								<?php if(!empty($soconfig_general_store[$store["store_id"]]) || !isset($soconfig_general_store[$store["store_id"]])){?>
								...
								<div class="tab-content">
									...
									<div class="tab-pane <?php echo ($subfix == 'lg' ? 'active' : ''); ?>" id="language-catalog_refine_<?php echo $subfix ?><?php echo $store["store_id"]; ?>">
										...
										<select name="soconfig_pages_store[<?php echo $store["store_id"]; ?>][product_catalog_refine_col_<?php echo $subfix; ?>]" class="form-control width30">
										   <?php 
											if(!empty($soconfig_pages_store[$store["store_id"]]) || !isset($soconfig_pages_store[$store["store_id"]])){
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="soconfig_advanced_store[<?php echo $store["store_id"]; ?>][scssformat]" class="form-control">
							<?php 
							if(!empty($soconfig_advanced_store[$store["store_id"]]) || !isset($soconfig_advanced_store[$store["store_id"]])){
							foreach ($Scssformat as $fv => $fc) { ?>
