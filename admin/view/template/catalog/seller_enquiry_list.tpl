                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <?php if(!$is_seller) { ?> <td class="text-left"><a href="javascript:void(1);"><?php echo $column_seller; ?></a></td> <?php } ?>
                        ...
                        <tbody>
                        <?php if ($seller_enquiries) { ?>
                        <?php $i=1; foreach ($seller_enquiries as $seller_enquiry) { ?>
                        <tr>
                            <td class="text-center"><?php echo $i++; ?></td>
                            <?php if(!$is_seller) { ?> <td class="text-left"><?php echo $seller_enquiry['seller_name']; ?></td> <?php } ?>
                            <td class="text-left"><?php echo $seller_enquiry['enquirer_name']; ?></td>
                            <td class="text-left"><?php echo $seller_enquiry['read_by_seller']; ?></td>
                            <td class="text-left"><?php echo $seller_enquiry['enquiry_date']; ?></td>
                            <td class="text-right"><a href="<?php echo $seller_enquiry['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
                        </tr>
                        <?php } ?>
                        <?php } else { ?>
                        <tr>
...
<script type="text/javascript"><!--
    $('#button-filter').on('click', function() {
        var url = 'index.php?route=catalog/seller_enquiry&token=<?php echo $token; ?>';
