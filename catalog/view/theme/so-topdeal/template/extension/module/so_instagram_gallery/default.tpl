	...
	$ch = curl_init();	curl_setopt($ch, CURLOPT_URL, 'https://api.instagram.com/v1/users/'.$users_id.'/media/recent?access_token='.$access_token.'&count='.$limit_image);	curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);	
	$json = curl_exec($ch);
	...
	?>
	<div class="module footer-links<?php echo $direction_class?> <?php echo $class_suffix; ?>">
		<?php if($disp_title_module) { ?>
		<h4 class="title-footer"><?php echo $head_name;?></h4>
